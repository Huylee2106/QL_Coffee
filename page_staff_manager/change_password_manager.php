...
if (!isset($_SESSION['id'])) {
    header("Location: ../login_staff_manager/login_manager.php");
    exit();
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($old_pass !== $user['password']) {
        ...
        if ($update->execute()) {
            echo "<script>alert('Đổi mật khẩu thành công!'); window.location.href='page_manager.php';</script>";
        }
    }
}
?>
    ...
    <div class="wrapper">
        <form method="POST">
            ...
            <div class="register-link">
                <p><a href="page_manager.php">Quay lại</a></p> <p><a href="..\login_staff_manager\forgot_pass.php">Quên mật khẩu</a></p>
            </div>
        </form>
    </div>
</body>
